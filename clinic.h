...
#define NO_DATE 0
#define OPENING_HOUR 10
#define CLOSING_HOUR 14
#define MIN_INTERVALS 30
...
//match patient information to appointment times
...
//get user input for time and min within a range
void inputAppointTime(int* hour, int* mins);

//validate patient number exists
